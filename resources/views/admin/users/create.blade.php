            ...
            <div>
                ...
                <div class="flex items-center space-x-4">
                    <label class="inline-flex items-center">
                        <input type="radio" name="is_active" value="1" class="w-4 h-4 text-indigo-600 focus:ring-indigo-500" {{ old('is_active', 1) == 1 ? 'checked' : '' }}>
                        <span class="ml-2 text-sm text-slate-700">Active</span>
                    </label>
                    <label class="inline-flex items-center">
                        <input type="radio" name="is_active" value="0" class="w-4 h-4 text-indigo-600 focus:ring-indigo-500" {{ old('is_active') == '0' ? 'checked' : '' }}>
